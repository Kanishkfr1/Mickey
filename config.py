...
OWNER_ID = int(getenv("OWNER_ID", 6452844553))
MONGO_URL = getenv("MONGO_URL", None)
SUPPORT_GRP = getenv("SUPPORT_GRP", "anime_galaxy_chat")
UPDATE_CHNL = getenv("UPDATE_CHNL", "anime_robots")
OWNER_USERNAME = getenv("OWNER_USERNAME", "kanishkfr")
